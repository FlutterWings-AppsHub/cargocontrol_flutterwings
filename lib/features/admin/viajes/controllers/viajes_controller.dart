...
class ViajesController extends StateNotifier<bool> {
  ...
  Future<void> updateVaijesModels({
    ...
    result.fold((l) {
      ...
      state = false;
      showToast(msg: Messages.viajesUpdatedSuccess);
    });
    state = false;
  }
