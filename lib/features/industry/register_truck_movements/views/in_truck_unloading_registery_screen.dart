...
class InRegisterTruckUnlaodingScreen extends StatefulWidget {
  ...
  @override
  State<InRegisterTruckUnlaodingScreen> createState() =>
      _InRegisterTruckUnlaodingScreenState();
}

class _InRegisterTruckUnlaodingScreenState
    extends State<InRegisterTruckUnlaodingScreen> {
        ...
        children: [
          ...
          Padding(
            ...
            child: TextField(
              ...
              style: getBoldStyle(
                  color: context.textColor, fontSize: MyFonts.size24),
              autocorrect: false,
          ...
          Expanded(
            ...
            child: Padding(
              padding: kIsWeb
                  ? EdgeInsets.symmetric(horizontal: 0.32.sw)
          ...
          Padding(
            ...
            child: Consumer(
              builder: (BuildContext context, WidgetRef ref, Widget? child) {
                final truckCtr =
                    ref.watch(inTruckRegistrationNotiControllerProvider);
                return CustomButton(
                  ...
                  onPressed: () async {
                    if (keyPadTextFieldController.text.isNotEmpty) {
                      if (keyPadTextFieldController.text.length != 6) {
                        showSnackBar(
                            context: context,
                            content: Messages.enterPlateNumberLengthError,
                      ...
                      if (truckCtr.currentIndustryModel != null) {
                        await ref
                            ...
                            .getMatchedViajesLinkedWithIndustry(
                                ...
                                viajesStatusEnum:
                                    ViajesStatusEnum.industryEntered,
                      ...
                      showSnackBar(
                          context: context,
                          content: Messages.enterPlateNumberError,
                          backColor: MyColors.red);
                    }
                  },
                );
