...
import '../../../admin/manage_ships/controllers/ship_noti_controller.dart';
import 'in_ship_card.dart';


@override
class InShipsList extends ConsumerStatefulWidget {
  const InShipsList({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AdChoferesListState();
}

class _AdChoferesListState extends ConsumerState<InShipsList> {
